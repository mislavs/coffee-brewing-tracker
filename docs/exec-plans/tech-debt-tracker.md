...
- `docs/architecture.md` should stay a high-level codemap. Move implementation details to feature docs, ADRs, execution plans, generated docs, or code comments.
