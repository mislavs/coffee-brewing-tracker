...
-- NOTE: Countries are seeded by migration with deterministic IDs:
--   Ethiopia=d3fe0924-2aea-5330-ad7c-b873723c5ed6
--   Colombia=5fcbb024-ce3b-512d-a41a-5db34415c7e9
--   Kenya=54174bed-37e8-5f34-85e7-88b8ac52e058
--   Brazil=6b93b346-f023-5a35-9228-969ca8454cb3
--   Guatemala=4a2e508b-412d-587d-9e68-0d9d4395d559
--   Indonesia=2a4357f0-7fa6-5ed0-84b5-27f12f5d80c1
--   United States=05a0a55d-f860-5b0e-af76-d3bf7d8a6df5
--   Norway=d87bef86-5d79-5777-9fa3-64d3c8691dba
...
INSERT INTO "Roasters" ("Id", "Name", "City", "CountryId") VALUES
  ...
  ('a0000001-0000-0000-0000-000000000001', 'Onyx Coffee Lab',         'Bentonville', '05a0a55d-f860-5b0e-af76-d3bf7d8a6df5'),
  ...
  ('a0000001-0000-0000-0000-000000000004', 'Tim Wendelboe',           'Oslo',         'd87bef86-5d79-5777-9fa3-64d3c8691dba');
...
INSERT INTO "BeanCountry" ("BeanId", "OriginCountriesId") VALUES
  ...
  ('d0000001-0000-0000-0000-000000000001', 'd3fe0924-2aea-5330-ad7c-b873723c5ed6'),
  -- bn2 Southern Weather: Brazil + Colombia (blend)
  ('d0000001-0000-0000-0000-000000000002', '6b93b346-f023-5a35-9228-969ca8454cb3'),
  ('d0000001-0000-0000-0000-000000000002', '5fcbb024-ce3b-512d-a41a-5db34415c7e9'),
  -- bn3 Githembe: Kenya (single origin)
  ('d0000001-0000-0000-0000-000000000003', '54174bed-37e8-5f34-85e7-88b8ac52e058'),
  -- bn4 Red Brick: Brazil + Guatemala + Colombia (blend, 3 countries)
  ('d0000001-0000-0000-0000-000000000004', '6b93b346-f023-5a35-9228-969ca8454cb3'),
  ('d0000001-0000-0000-0000-000000000004', '4a2e508b-412d-587d-9e68-0d9d4395d559'),
  ('d0000001-0000-0000-0000-000000000004', '5fcbb024-ce3b-512d-a41a-5db34415c7e9'),
  -- bn5 Tropical Weather: Colombia (single origin)
  ('d0000001-0000-0000-0000-000000000005', '5fcbb024-ce3b-512d-a41a-5db34415c7e9'),
  -- bn6 El Vergel: Colombia (single origin)
  ('d0000001-0000-0000-0000-000000000006', '5fcbb024-ce3b-512d-a41a-5db34415c7e9'),
  -- bn7 Limu Natural: Ethiopia (single origin)
  ('d0000001-0000-0000-0000-000000000007', 'd3fe0924-2aea-5330-ad7c-b873723c5ed6');
